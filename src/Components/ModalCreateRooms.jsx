...
const ModalCreateRooms = ({ open, setOpen,fetchRooms }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            room.status = true;
            const response = await RoomsService.createRoom(room);
            fetchRooms();
    ...
    return <Modal show={open} onHide={handleClose} position="center">
        <Modal.Header closeButton>
            <Modal.Title className="text-dark">Crée une chambre</Modal.Title>
        </Modal.Header>
...
export default ModalCreateRooms;